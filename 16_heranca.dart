void main() {
  ...
  Filho filho1 = Filho('Pedro', 10, 'Escola da prefeitura');
  filho1.apresenta();
}
...
class Pai extends Pessoa {
  ...
  void apresenta() {
    print(
      'Meu nome é $nome e minha idade é $idade anos e minha profissao é $profissao',
    );
  }
}
...
class Filho extends Pessoa {
  ...
  @override
  void apresenta() {
    print('Meu nome é $nome e minha idade é $idade anos e estudo na $escola');
  }
}
